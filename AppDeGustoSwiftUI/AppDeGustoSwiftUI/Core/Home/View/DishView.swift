...
struct DishView: View {
    ...
    var body: some View {
        ZStack {
            ...
            ButtonAddToCarView(dish: $dish, business: business, total: Float(dish.dishPrice * Double(valor!)) +
